...
function buildExtension(extensonName, extensionPath) {
    ...
    return builder.process().then(function () {
        ...
        var cssFile = builder.getFile(extensonName + '/' + extensonName + '.less');
        var html = '';
        // // 将css内容打包到js文件中
        // if (cssFile) {
        //     html += '(function(){'
        //         + 'var stylesheet=document.createElement(\'style\');'
        //         + 'stylesheet.innerHTML=\'' + string.escapeJS(cssFile.getData()) + '\';'
...
module.exports = function () {
    ...
    return function (context) {
        ...
        var extensionPath = path.join(extensionsDir, extensonName);
