...
exports.pageCustomInject = function (content) {
    const regex = /(<script.+?src=")([^"]+)"/g;
    return content.replace(regex, ($0, script, src) => {
        if (src.indexOf('mipcache.bdstatic.com/static/v1/mip-custom') === -1
            && src.indexOf('c.mipcdn.com.com/static/v1/mip-custom') === -1) {
            return $0;
        }
