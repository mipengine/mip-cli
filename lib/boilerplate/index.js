...
module.exports = {
    ...
    element: function (options) {
        ...
        // 模板生成映射
        var templateMap = {
            'extensions/element.js': 'extensions/${name}/${name}.js',
            'extensions/element.less': 'extensions/${name}/${name}.less',
            'extensions/README.md': 'extensions/${name}/README.md',
            'extensions/package.json': 'extensions/${name}/package.json'
        };
