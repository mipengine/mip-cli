...
function startServer(config) {
    ...
    // 配置了mipmain目录，则增加mipmain调试路径
    if (config.mipmainDir) {
        cli.info('mip main debug path', cli.chalk.green(config.mipmainDir));
        app.use('/mipmain', express.static(config.mipmainDir));
    }
 ...
 * @param  {string} config.mipmainDir 配置本地mipmain仓库目录，用于mipmain调试
 */
