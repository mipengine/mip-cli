...
module.exports = {
    ...
    page: function (options) {
        var content = render.render(boilerplate.readTemplate('mip.html'), options);
    ...
    element: function (options) {
        ...
        Object.keys(templateMap).forEach(function (templatePath) {
            var content = render.render(boilerplate.readTemplate(templatePath), options);
    ...
    config: function (options) {
        var content = render.render(boilerplate.readTemplate('mip.config'), options);
